	...
	*/
	...
	function Move(){ 
		...
		if($firstBG.hasClass("inview")){
			...
			bg1.css({'backgroundPosition': newPos(0, windowHeight, pos, 500, 0)});
		}
		...
		if($secondBG.hasClass("inview")){
			...
			bg2.css({'backgroundPosition': newPos(70, windowHeight, pos, 2010, 0.2)});
			//call the newPos function and change the second background position
		}
		...
		if ($thirdBG.hasClass("inview")){
			//menulogo.show();
			//call the newPos function and change the background position
			$thirdBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 500, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, -200, 0.2)});
			//call the newPos function and change the second background position
		}
		...
		if ($fourthBG.hasClass("inview")){
			...
			$fourthBG.css({'backgroundPosition': newPos(0, windowHeight, pos, 2550, 0)});
			//$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1550, 0.3)});
			//call the newPos function and change the second background position
			bg4.css({'backgroundPosition': newPos(70, windowHeight, pos, 1050, 0.2)});
		}
