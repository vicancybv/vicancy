...
Vicancy::Application.configure do
  ...
  config.assets.precompile += %w( static_index.css )
  ...
  config.assets.precompile += %w( embed-api.js )
  config.assets.precompile += %w( reseller-api.js reseller-api.css )
