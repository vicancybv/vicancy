...
Webflow.require('ix').init([
  {"slug":"popup","name":"popup","value":{"style":{"opacity":0,"scale":0.8},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","scale":1.04},{"transition":"transform 500ms ease 0ms","scale":1}],"stepsB":[]}]}},
  {"slug":"slideinleft","name":"slideInLeft","value":{"style":{"opacity":0,"x":"-100px","y":"0px"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 800ms ease 0ms, opacity 800ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"slideinright","name":"slideInRight","value":{"style":{"opacity":0,"x":"100px","y":"0px"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 800ms ease 0ms, opacity 800ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"slideinup","name":"slideInUp","value":{"style":{"opacity":0,"x":"0px","y":"100px"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 1000ms ease 0ms, opacity 1000ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"developer-button","name":"developer button","value":{"style":{},"triggers":[{"type":"click","selector":".back-end-developer-text","stepsA":[{"display":"block"}],"stepsB":[{"display":"none","wait":500}]}]}},
  {"slug":"developer-text","name":"developer text","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"designer-button","name":"designer button","value":{"style":{},"triggers":[{"type":"click","selector":".front-end-developer-text","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]}]}},
  {"slug":"growth-button","name":"growth button","value":{"style":{},"triggers":[{"type":"click","selector":".online-video-marketeer","stepsA":[{"display":"block"}],"stepsB":[{"display":"none"}]}]}},
  {"slug":"bulk","name":"bulk","value":{"style":{},"triggers":[]}},
  {"slug":"new-interaction","name":"New Interaction","value":{"style":{},"triggers":[]}},
  {"slug":"popupbelow","name":"popupbelow","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"show-and-hide","name":"Show and Hide","value":{"style":{},"triggers":[{"type":"click","selector":".custom-template-paragraph","stepsA":[{}],"stepsB":[]}]}}
]);
